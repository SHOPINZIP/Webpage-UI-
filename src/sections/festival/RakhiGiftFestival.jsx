  ...
  >
    ...
    {[
      ...
      <g key={i}>
        <circle
          ...
          strokeWidth="0.8"
        />
        <circle cx={x - 1.5} cy={y - 1.5} r="1.5" fill="#fff" opacity="0.4" />
      </g>
    ))}
    {[
      [278, 102],
    ...
    {Array.from({ length: 12 }).map((_, i) => {
      const a = (i / 12) * Math.PI * 2,
        px = 150 + 60 * Math.cos(a),
        py = 107 + 60 * Math.sin(a);
      return (
        <ellipse
          key={i}
          cx={px}
    ...
    {Array.from({ length: 8 }).map((_, i) => {
      const a = (i / 8) * Math.PI * 2,
        px = 150 + 33 * Math.cos(a),
        py = 107 + 33 * Math.sin(a);
      return (
        <ellipse
          key={i}
          cx={px}
    ...
    {Array.from({ length: 8 }).map((_, i) => {
      const a = (i / 8) * Math.PI * 2 + Math.PI / 8,
        px = 150 + 19 * Math.cos(a),
        py = 107 + 19 * Math.sin(a);
      return (
        <ellipse
          key={i}
          cx={px}
  ...
  >
    ...
    {[
      ...
      <g key={i}>
        ...
        />
        <circle cx={x - 3} cy={y - 3} r="4" fill="#FFC56B" opacity="0.4" />
      </g>
    ))}
    <circle
      cx="150"
    ...
    {[
      ...
      <g key={i}>
        <circle
          ...
          opacity="0.65"
        />
        <circle cx={150 + x} cy={y} r="2.5" fill="#fff" opacity="0.5" />
      </g>
    ))}
...
const IllSilver = () => (
  ...
  >
    ...
    {[
      ...
      <g key={i}>
        <circle
          ...
          strokeWidth="0.8"
        />
        <circle cx={x - 1.5} cy={y - 1.5} r="1.8" fill="#fff" opacity="0.6" />
      </g>
    ))}
    {[
      [278, 106],
    ...
    {Array.from({ length: 8 }).map((_, i) => {
      const a = (i / 8) * Math.PI * 2,
        px = 150 + 32 * Math.cos(a),
        py = 107 + 32 * Math.sin(a);
      return (
        <ellipse
          key={i}
          cx={px}
    ...
    {Array.from({ length: 8 }).map((_, i) => {
      const a = (i / 8) * Math.PI * 2 + Math.PI / 8,
        px = 150 + 18 * Math.cos(a),
        py = 107 + 18 * Math.sin(a);
      return (
        <ellipse
          key={i}
          cx={px}
...
function readCardBlock(block, index) {
  const nested =
    block && typeof block.props === "object" && block.props ? block.props : {};
...
export default function RakhiGiftFestival({ section, theme }) {
  ...
  const cards = useMemo(
    () =>
      rawBlocks
        .filter(
          (b) =>
            b && typeof b === "object" && safeText(b.type) !== PETAL_BLOCK_TYPE,
        )
  ...
  const renderCard = (card) => (
    ...
    >
      ...
      >
        {card.title ? (
          <h3 style={{ ...cardTitleStyle, fontSize: 21, margin: 0 }}>
            {card.title}
          </h3>
        ) : null}
        {card.subtitle ? (
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={textStyle("heroTitleLineOne", "heading")}>
      ...
      {cards.length > 0 ? (
        ...
        >
          <div style={{ textAlign: "center", marginBottom: 44 }}>
            ...
            >
              <span style={textStyle("collectionHeadingLineOne", "heading")}>
                {content("collectionHeadingLineOne")}{" "}
              </span>
              <span
                style={{
