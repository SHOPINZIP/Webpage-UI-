...
declare function AppleFlipCardTestimonials({ section, appearance, theme, }: MessageStyleTestimonialsProps): React.JSX.Element;

declare function AppleMessageTestimonials({ section, appearance, theme, }: MessageStyleTestimonialsProps): React.JSX.Element;
...
type ReelsSectionPadding = "small" | "medium" | "large";
type ReelItemBlock = {
    id: string;
...
type ReelsSectionSettings = {
    props?: ReelsSectionControls;
    blocks?: ReelItemBlock[];
};
type ReelsSectionDoc = {
    id: string;
    type: "reels_section";
    enabled?: boolean;
    settings: ReelsSectionSettings;
};
type FannedPhoneReelsProps = {
    section: ReelsSectionDoc;
    appearance?: ResolvedSectionAppearance | null;
    theme?: StorefrontTheme | null;
};

declare function FannedPhoneReels({ section, appearance, theme, }: FannedPhoneReelsProps): React.JSX.Element | null;

type FestivalSectionPadding = "small" | "medium" | "large";
type FestivalIllustrationType = "rakhi" | "mithai" | "puja" | "silver" | "hamper" | "floral" | "customImage";
type FestivalCardBlock = {
    id: string;
...
type FestivalBlock = FestivalCardBlock | FestivalPetalBlock;
type FestivalSectionControls = {
...
type FestivalSectionSettings = {
    props?: FestivalSectionControls;
    blocks?: FestivalBlock[];
};
type FestivalSectionDoc = {
    id: string;
    type: "festival";
    variant?: string;
    enabled?: boolean;
...
type RakhiGiftFestivalProps = {
    section: FestivalSectionDoc;
    appearance?: ResolvedSectionAppearance | null;
    theme?: StorefrontTheme | null;
};
type NavratriWordBlock = {
    id?: string;
...
type NavratriBlock = NavratriWordBlock | NavratriFeatureBlock | NavratriBadgeBlock;
type NavratriSectionControls = {
    eyebrowText?: string;
...
type NavratriSectionSettings = {
    props?: NavratriSectionControls;
    blocks?: NavratriBlock[];
};
type NavratriSectionDoc = {
    id: string;
    type: "festival";
    variant?: string;
    enabled?: boolean;
...
declare const NavratriDandiyaHero: (props: NavratriDandiyaHeroProps) => JSX.Element | null;
...
declare const NSP_POKER_FRONT_CARD_EYEBROW_DEFAULT: TextStyle;
declare const NSP_POKER_FRONT_CARD_TITLE_DEFAULT: TextStyle;
